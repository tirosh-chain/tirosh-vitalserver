...
### 3-3. VM Image update bundle 만들기
...
| 영역 | 기준 문서 |
|---|---|
| 문서군 전체 지도 | [macOS Runtime Overview](overview.md) |
| 제품 구조와 책임 분리 | [Architecture](architecture.md) |
| 상태 전이와 검증 기준 | [State Machine Traceability](state-machine-traceability.md) |
