...
| TS-234 | 설치된 Host proxy가 bundled nginx dylib 누락으로 반복 종료됨 | Packaging / Host proxy | active | [Packaged nginx runtime dylib closure is missing](234_packaged-nginx-runtime-dylib-closure-missing.md) |
