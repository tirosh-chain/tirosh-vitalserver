enum AppConstants {
    ...
    enum StatusText {
        ...
        static let settingsDraftSaved = "Settings saved. Apply Settings is required to update the running runtime."
        ...
        static let bridgedInterfaceRequired = "Choose a bridged interface before applying settings."
    ...
    enum UserDefaultsKeys {
        static let settingsDraft = "tirosh.vitalserver.manager.settingsDraft"
    }
