...
@MainActor
final class RuntimeViewModelStatusRefresherTests: XCTestCase {
    func testRefreshHealthStatusLoadsHealthSnapshotAndFormatsMessage() async {
        ...
        let refresher = RuntimeViewModelStatusRefresher(snapshots: snapshots)
...
@MainActor
private final class StubStatusSnapshotLoader: RuntimeViewModelStatusSnapshotLoading {
    let status: RuntimeStatus
