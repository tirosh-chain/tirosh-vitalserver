...
final class RunUninstallRuntimeUseCaseTests: XCTestCase {
    func testCleanUninstallStopsServicesBeforeRemovingInstalledFilesAndTools() throws {
        let harness = RunUninstallRuntimeUseCaseHarness()
    ...
    func testStandardUninstallCreatesBackupAndPreservesUserData() throws {
        let harness = RunUninstallRuntimeUseCaseHarness(externalVitalFilesDirectory: nil)
...
private final class RunUninstallRuntimeUseCaseHarness {
    var events: [String] = []
