public enum RuntimeDiagnosticsArtifactFileNames {
    public static let runtimeStatus = "runtime-status.json"
    public static let runtimeProgress = "runtime-progress.json"
    ...
    public static let runtimeObservation = "runtime-observation.json"
