...
enum RecorderActivityBucketInterval: Int, CaseIterable, Identifiable {
    case oneMinute = 60
...
enum RecorderActivityPeriod: String, CaseIterable, Identifiable {
...
struct RecorderActivityChartBucket: Identifiable {
...
struct RecorderActivityChartBucketBuilder {
    let bucketStartedAt: String
    let bucketSeconds: Int
    var messageCount = 0
    var byteCount = 0
...
enum RuntimeRecorderActivityDateParser {
