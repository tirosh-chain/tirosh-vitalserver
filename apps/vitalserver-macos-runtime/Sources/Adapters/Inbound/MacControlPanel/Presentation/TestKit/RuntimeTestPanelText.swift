...
enum RuntimeTestPanelText {
    ...
    static let testKitContainer = "TestKit container"
    ...
    static let startingTestKitContainer = "Starting TestKit container..."
    static let stoppingTestKitContainer = "Stopping TestKit container..."
    static let restartingTestKitContainer = "Restarting TestKit container..."
    static let startedTestKitContainer = "Started TestKit container."
    static let stoppedTestKitContainer = "Stopped TestKit container."
    static let restartedTestKitContainer = "Restarted TestKit container."
