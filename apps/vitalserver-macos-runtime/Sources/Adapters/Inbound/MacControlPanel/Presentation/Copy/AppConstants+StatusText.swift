...
public extension AppConstants {
    enum StatusText {
        ...
        public static let cleanUninstallConfirmation = "Removes the Helper app, runtime services, tools, VM disk, logs, backups, Redis backups, package receipt, and the Helper-managed default Vital files directory. A configured external Vital files directory is preserved."
