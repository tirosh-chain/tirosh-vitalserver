...
public extension AppConstants {
    enum Labels {
        ...
        public static let bundleVerificationHelp = "Authenticates the publisher signature and verifies the target, next updater, specification, and complete payload closure."
        public static let applyUpdateHelp = "Applies an authenticated product update through the stable bootstrap. Runtime services may restart while the operation is active."
