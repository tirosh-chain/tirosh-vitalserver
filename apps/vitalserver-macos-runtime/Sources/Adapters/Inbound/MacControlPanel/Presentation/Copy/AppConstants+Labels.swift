...
public extension AppConstants {
    enum Labels {
        ...
        public static let redisBackupRetention = "Backup archives"
        public static let redisBackupRetentionHelp = "Number of VitalServer Helper backup archives to keep, up to 30. These archives include Redis data. Older archives are pruned after a new verified backup is created."
