...
public extension AppConstants {
    enum Labels {
        ...
        public static let recorderIngressLoadControlHelp = "Queues recorder send_data and replays it at a controlled speed to reduce VitalServer load."
        ...
        public static let recorderIngressSendDataModeHelp = "Controls how VRecorder send_data enters VitalServer. Spool + replay is the operating mode: direct upstream relay is suppressed and replay is rate controlled. Mirror keeps direct relay and only stores a diagnostic copy."
