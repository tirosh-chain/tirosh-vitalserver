...
public extension AppConstants {
    enum Labels {
        ...
        public static let sectionLab = "Lab"
        ...
        public static let resourceUsageHelp = "VM and container memory usage is reported by the Linux guest. VM available memory can be slightly lower than the configured allocation because the guest OS reserves memory for kernel and device overhead."
        public static let vitalServerMemoryUsage = "VitalServer memory"
        public static let recorderIngressMemoryUsage = "Recorder ingress memory"
        public static let redisMemoryUsage = "Redis memory"
        ...
        public static let recorderIngress = "Recorder ingress"
        public static let recorderIngressQueue = "Recorder ingress queue"
        public static let recorderIngressConnections = "Connections"
        public static let recorderIngressThroughput = "Throughput"
        public static let recorderIngressOldestPending = "Oldest pending"
        public static let recorderIngressReplay = "Replay"
        public static let recorderIngressInFlight = "In flight"
        public static let recorderIngressReplayLag = "Replay lag"
        public static let recorderIngressBackpressureRejected = "Backpressure rejected"
        public static let recorderIngressRetryableFailures = "Retryable failures"
        public static let recorderIngressDeadLetters = "Dead letters"
        public static let recorderIngressLastFailure = "Last failure"
        public static let recorderIngressLoadControl = "Recorder load control"
        public static let recorderIngressLoadControlHelp = "Observe only is the stable default: original send_data continues directly to VitalServer, audit/metrics and bounded raw archive evidence are recorded, and replay spool is disabled. Load control is unavailable in this mode."
        public static let recorderIngressLoadControlRisk = "Spool + replay is degraded until a durable Recorder admission acknowledgement exists. It suppresses direct delivery before persistence is acknowledged, so an admission failure can lose send_data."
        public static let recorderIngressSendDataMode = "send_data mode"
        public static let recorderIngressSendDataModePassthrough = "Passthrough"
        public static let recorderIngressSendDataModeObserveOnly = "Observe only"
        public static let recorderIngressSendDataModeMirrorSpool = "Mirror"
        public static let recorderIngressSendDataModeSpoolOnly = "Spool only"
        public static let recorderIngressSendDataModeSpoolAndReplay = "Spool + replay"
        public static let recorderIngressSendDataModeHelp = "Controls how VRecorder send_data enters VitalServer. Observe only preserves direct delivery and records bounded raw archive evidence without a replay queue. Spool + replay is an explicit degraded mode until durable admission acknowledgement is implemented."
        public static let recorderIngressReplayBatchSize = "Replay batch size"
        public static let recorderIngressReplayBatchSizeHelp = "Maximum send_data items the replay worker may claim per tick. Effective throughput is capped by the replay throughput limit."
        public static let recorderIngressReplayThroughput = "Replay throughput"
        public static let recorderIngressMaxReplayThroughput = "Max replay throughput"
        public static let recorderIngressReplayThroughputHelp = "Upper limit for recorder send_data payload replayed to upstream VitalServer per second while load control is on. Adaptive replay may lower the current throughput under load."
        public static let recorderIngressHotColdPath = "Recorder archive"
        public static let recorderIngressPendingMiB = "Hot path storage"
        public static let recorderIngressRawArchiveFileMiB = "Archive file size"
        public static let recorderIngressRawArchiveFiles = "Archive retention"
        public static let recorderIngressHotColdPathHelp = "Keeps recorder ingress data durable and automatically exports completed archive files for all connected recorders. Changes apply when the Guest stack is reconciled."
        public static let containerMemoryLimits = "Container memory limits"
        public static let containerMemoryLimitsHelp = "Applies hard Docker memory limits to selected runtime containers after the Guest stack is reconciled."
        public static let vitalServerContainerMemoryLimit = "VitalServer limit"
        public static let recorderIngressContainerMemoryLimit = "Recorder ingress limit"
        public static let redisContainerMemoryLimit = "Redis limit"
        public static let unitMiB = "MiB"
        public static let unitMiBPerSecond = "MiB/s"
        ...
        public static let guestLogSyncService = "Log sync service"
        public static let sleepPreventionService = "Sleep prevention service"
        public static let watchdogService = "Watchdog service"
        public static let guestProductServices = "Runtime product services"
        ...
        public static let sectionServiceHealth = "Service state"
        public static let sectionPlatformServices = "Platform services"
        public static let sectionRuntimeProductServices = "Runtime product services"
        public static let sectionAccessEndpoints = "Access endpoints"
        public static let sectionAPICatalog = "Access endpoints"
        public static let runtimeProviderService = "Runtime provider service"
        ...
        public static let sectionRuntimeControlRecovery = "Runtime Control connection"
        ...
        public static let runtimeControlRecoveryHelp = "Relaunches this Helper and requests a new local browser session from the Platform Agent. This does not rotate the root-owned automation token or restart VitalServer."
        ...
        public static let redisRelayTargetURLHelp = "Example: redis://redis.example:6379/0. For a host or VM target, use its reachable IP address, such as redis://192.168.64.1:16381/0. TLS is applied from the field below. Username and password are stored in secret files, not in the URL."
        ...
        public static let redisRelayClearUsername = "Clear saved username"
        public static let redisRelayUsernameConfigured = "Saved username is configured. Leave blank to keep it. The value is not shown."
        ...
        public static let sectionBundleVerification = "Bundle integrity"
        ...
        public static let bundleVerificationHelp = "Checks the manifest, sizes, and checksums. Publisher authenticity is not verified."
        public static let applyUpdateHelp = "This 0.2.1 build cannot apply updates because trusted publisher verification is unavailable. VM/rootfs level changes are administrator-level operations."
        ...
        public static let requiresGuestStackReconcile = "Requires Guest stack reconcile"
        ...
        public static let destructiveOperationsHelp = "Standard Uninstall retains logs, backups, Redis backups, and the known legacy product-root Vital files directory outside the installed product root so a fresh package install remains possible. The shared managed default and safe configured external Vital files remain in place. Clean Uninstall removes both known managed defaults and product-owned retained archives; safe configured external Vital files remain in place. If SQLite ownership state is unavailable or ambiguous, normal uninstall stops before effects; Force Clean is an explicit destructive recovery with limited preservation proof."
