...
public extension AppConstants {
    enum Labels {
        ...
        public static let recorderIngressReplayBatchSizeHelp = "Maximum send_data items the replay worker may claim per tick. Effective throughput is also capped by the replay rate limit."
        public static let recorderIngressReplayRateLimit = "Replay rate limit"
        public static let recorderIngressReplayRateLimitHelp = "Maximum send_data items replayed to upstream VitalServer per second. Increase this when pending grows without replay failures."
        public static let unitItems = "items"
        public static let unitItemsPerSecond = "items/sec"
