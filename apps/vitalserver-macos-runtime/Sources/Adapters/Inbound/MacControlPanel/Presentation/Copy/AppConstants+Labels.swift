...
public extension AppConstants {
    enum Labels {
        ...
        public static let recorderIngressHotColdPathHelp = "Keeps recorder ingress data durable and automatically exports completed archive files for all connected recorders. Changes apply when container services are reconciled."
        public static let containerMemoryLimits = "Container memory limits"
        public static let containerMemoryLimitsHelp = "Applies hard Docker memory limits to selected runtime containers after container services are reconciled."
