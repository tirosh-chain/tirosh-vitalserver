...
public extension AppConstants {
    enum Labels {
        ...
        public static let sectionRuntimeDataRecovery = "Runtime data backup"
        ...
        public static let runtimeDataRecoveryHelp = "Create or restore a runtime data backup for UI continuity data, settings, host runtime state, observability data, and Redis data."
        ...
        public static let runtimeDataBackup = "Runtime data backup"
