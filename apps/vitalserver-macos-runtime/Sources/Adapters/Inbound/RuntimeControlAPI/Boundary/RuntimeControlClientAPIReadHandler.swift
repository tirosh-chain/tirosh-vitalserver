...
public struct RuntimeControlClientAPIReadHandler: RuntimeControlAPIReadHandler {
    ...
    public func loadRecorderObservabilityTimeline(
        ...
        client.loadRecorderObservabilityTimeline(query: query)
    }
    ...
    public func loadRecorderObservabilityIncidents(
        ...
        client.loadRecorderObservabilityIncidents(query: query)
    }
    ...
    public func stopLabRecorder(sessionId: String, recorderId: String) async throws -> RuntimeLabRecorderResponse {
        try await client.stopLabRecorder(sessionId: sessionId, recorderId: recorderId)
    }
