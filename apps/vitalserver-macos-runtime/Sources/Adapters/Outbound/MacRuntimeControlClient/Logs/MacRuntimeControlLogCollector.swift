...
struct MacRuntimeControlLogCollector: RuntimeLogCollecting, @unchecked Sendable {
    ...
    init(
        ...
        archiveDirectory: URL = InstalledRuntimePaths.defaultInstalled.logArchiveDirectory,
        archiveRetention: RuntimeLogArchiveRetentionConfiguration? = nil,
        runtimeControlSettingsPath: URL = InstalledRuntimePaths.defaultInstalled.runtimeControlSettings,
