...
enum RuntimeCommandFactory {
    ...
    static func configureRuntimeArguments(
        ...
        var arguments = [
            ...
            RuntimeControlClientConstants.RuntimeCommand.optionRecorderIngressSendDataReplayRateLimitPerSecond,
            String(settings.recorderIngressSendDataReplayRateLimitPerSecond),
