...
@main
struct MacManagerApplication: App {
    @StateObject private var controller = RuntimeController.live()
    ...
    var body: some Scene {
        ...
        .commands {
            MacManagerCommands(controller: controller)
        }
    }
}

private struct MacManagerCommands: Commands {
