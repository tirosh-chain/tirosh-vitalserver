...
.PHONY: help help-runtime help-internal
help:
	@printf "tirosh-vitalserver\n"
	@printf "\n"
	@printf "Core:\n"
	@printf "  make help            Show daily-use commands\n"
	@printf "  make help-runtime    Show macOS runtime package, update, and VM commands\n"
	@printf "  make help-internal   Show low-level build and troubleshooting commands\n"
	@printf "\n"
	@printf "Setup:\n"
...
help-internal:
	@printf "tirosh-vitalserver internal commands\n"
	@printf "\n"
	@printf "Proxy troubleshooting:\n"
	...
	@printf "  make config          Print resolved Compose config\n"
