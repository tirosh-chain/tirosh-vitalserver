...
vm-version-source:
	@test -s "$(VM_VERSION_FILE)" || { printf "missing version file: %s\n" "$(VM_VERSION_FILE)" >&2; exit 1; }
	@mkdir -p "$(dir $(VM_GENERATED_VERSION_SWIFT))"
	@{ \
		printf "// Generated from %s by make vm-version-source.\n" "$(VM_VERSION_FILE)"; \
		printf "// Do not edit this file directly.\n\n"; \
		printf "extension Constants {\n"; \
		printf "    static let launcherVersion = \"%s\"\n" "$(VM_PRODUCT_VERSION)"; \
		printf "}\n"; \
	} > "$(VM_GENERATED_VERSION_SWIFT)"
