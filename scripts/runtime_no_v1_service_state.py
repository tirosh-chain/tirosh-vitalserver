...
def check_redis_relay_status_docs_use_guest_control_api_flow() -> CheckResult:
    ...
    required = [
        ...
        (relative(redis_relay_loop_path), "status_publisher"),
        (relative(redis_relay_loop_path), "_record_status("),
        (relative(redis_relay_loop_path), "StatusPublishError"),
        ...
        (relative(redis_relay_status_path), "os.replace"),
        (relative(redis_relay_status_path), '"scope": None'),
        (relative(redis_relay_owner_path), "class HttpStatusOwnerPublisher"),
        (relative(redis_relay_owner_path), "class UnixSocketStatusOwnerPublisher"),
        ...
        (relative(redis_relay_main_path), "status owner URL and socket cannot be configured together"),
