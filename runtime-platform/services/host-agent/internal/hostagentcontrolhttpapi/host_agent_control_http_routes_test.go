...
func TestRuntimeFacadeAllowlistIncludesOnlyPublishedOperationalRoutes(t *testing.T) {
	for _, path := range []string{
		...
		"/v1/runtime/lab/replays/lab-replay-1",
		...
		"/v1/runtime/artifacts/artifact-1",
		"/v1/runtime/archive/export-provider",
		"/v1/runtime/archive/credential-material",
		...
		"/v1/runtime/recorders",
		"/v1/runtime/recorders/recorder-1/observability",
		"/v1/runtime/recorders/recorder-1/observability/timeline",
		"/v1/runtime/recorders/recorder-1/observability/incidents",
		"/v1/runtime/recorders/recorder-1/artifacts",
	...
	for _, path := range []string{
		...
		"/v1/runtime/relay-targets",
		"/v1/time/authorities",
		"/v1/runtime/recorders/recorder-1/observability-expectation",
	...
	for _, path := range []string{
		...
		"/v1/runtime/recorders/recorder-1/observability/extra",
		"/v1/runtime/recorders/recorder-1/observability-expectation/extra",
		"/v1/runtime/operational-state/operations",
		"/v1/runtime/operational-state/operations/backup-operation-1/extra",
		"/v1/runtime/operational-state/backups/extra",
		"/v1/runtime/operational-state/restores/extra",
	} {
		if allowedRuntimeCommand(path) {
