...
func testManifest(root string) hostinstallationmanagerdomain.HostProductInstallationManifest {
	...
	return hostinstallationmanagerdomain.HostProductInstallationManifest{
		...
		OperatorInterface: hostinstallationmanagerdomain.HostProductOperatorInterface{BootstrapConfigurationPath: filepath.Join(root, "control", "runtime-console-bootstrap.json"), BootstrapConfigurationSHA256: "bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb", ApplicationBundlePath: hostinstallationmanagerdomain.MacOSHostProductOperatorApplicationBundlePath, ApplicationBundleTreeSHA256: "ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff", ApplicationBundleEntrypointRelativePath: hostinstallationmanagerdomain.MacOSHostProductOperatorApplicationEntrypointRelativePath},
