...
func TestAdmissionAcceptsLinuxWhenC48TopologyIsStable(t *testing.T) {
	...
	active.OperatorInterface.ApplicationBundlePath = ""
	active.OperatorInterface.ApplicationBundleTreeSHA256 = ""
	active.OperatorInterface.ApplicationBundleEntrypointRelativePath = ""
	candidate := active
