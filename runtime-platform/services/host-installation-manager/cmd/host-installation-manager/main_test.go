...
func declaredPathManifest() hostinstallationmanagerdomain.HostProductInstallationManifest {
	...
	return hostinstallationmanagerdomain.HostProductInstallationManifest{
		...
		OperatorInterface: hostinstallationmanagerdomain.HostProductOperatorInterface{BootstrapConfigurationPath: "/Library/Application Support/VitalServerRuntimePlatform/control/runtime-console-bootstrap.json", BootstrapConfigurationSHA256: "bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb"},
