...
| 목적 | 문서 |
|---|---|
| 연구/배포 배경 이해 | `background.md` |
| Mac 하드웨어 기반 appliance 선택 이유 | `mac-hardware-appliance.md` |
| Health Check 서비스 이해 | `health-check-service.md` |
| 병원 내/외 사용 모드 비교 | `deployment-modes.md` |
| 설치 흐름 확인 | `installation.md` |
| 운영 흐름 확인 | `operation.md` |
| 장애 대응 흐름 확인 | `troubleshooting.md` |
